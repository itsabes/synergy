sikatApp.controller("formAController", function(
                      ...
                      if (monthlyData[key].denumerator == 0 && monthlyData[key].numerator != 0) {
                          ...
                          //}
                            if($rootScope.currPage =='hcu'){
                                ...
                                if($scope.monthSelect == "6" || $scope.monthSelect == "7" || $scope.monthSelect =="8"){
                                    monthlyData[key].hasil = 100;
                                }

                            }else if($rootScope.currPage =='k3rs'){
                                if($scope.monthSelect == "1" || $scope.monthSelect == "2" || $scope.monthSelect =="3"){
                                    monthlyData[key].hasil = 100;
                                }
                          ...
                          var target = result.data[key]['TARGET_PENCAPAIAN'] !== null && result.data[key]['TARGET_PENCAPAIAN'] !== undefined ? 
  ...
  $scope.save = () => {
      ...
      let monthlyData = $scope.monthlyData.filter(item => {
        return item && 
        typeof item.numerator === 'number' && item.numerator >= 0 &&
        typeof item.denumerator === 'number' && item.denumerator >= 0 &&
      ...
      $http
          ...
          .then(
              ...
              function() {
                  ...
                  $.toast({
                      heading: "Error",
                      text: "Error happen when trying to get data on " +
                          yearSelect +
      ...
      $http
          ...
          .then(
              ...
              function() {
                  $.toast({
                      heading: "Error",
                      text: "Error happen when trying to delete data on " +
                          url +
                          ", please try again or contact support.",
                      position: "top-right",
                      loaderBg: "#ff6849",
